...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Welcome <span><?php echo $uname; ?>!</span> You're part of the Bastion Movement!</h1>
            <img src="/image/cybersecurity_audit.jpg" width="400px" alt="">
            <p>we are offering Network security, Penetration testing, Data protection and Endpoint security among more</p>
